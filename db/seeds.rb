...
properties = Property.create([
  {
    ...
    amenities: 'Free Wifi, Dish network, Pool',
    policies: 'No smoking',
    price_per_night: 50,
    max_guests: 2,
    bedrooms: 0,
    ...
    amenities: 'Pool table, Free Wifi',
    policies: 'No smoking, Free cancellation for 48 hours',
    price_per_night: 59,
    max_guests: 3,
    bedrooms: 3,
    beds: 2,
    ...
    amenities: 'Iron, Wifi, Elevator, Kitchen',
    policies: 'Smoking available outside, Pets allowed, No charcoal grills',
    price_per_night: 70,
    max_guests: 1,
    bedrooms: 1,
    beds: 1,
    ...
    country: 'us',
    property_type: 'entire apartment',
    amenities: 'Large patio, Wifi, Nearby transportation',
    policies: 'No parties, Be respectful of neighbor',
    price_per_night: 80,
    max_guests: 4,
    bedrooms: 0,
    beds: 3,
